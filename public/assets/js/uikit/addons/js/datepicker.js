...
(function(global, $, UI){
    ...
    dropdown.on("click", ".uk-datepicker-next, .uk-datepicker-previous, [data-updatedAt]", function(e){
        e.stopPropagation();
        e.preventDefault();

        var ele = $(this);

        if(ele.is('[data-updatedAt]')) {
                ...
                if (data.days[i] && data.days[i].length){
                    ...
                    for(var d = 0; d < data.days[i].length; d++) {
                        if (data.days[i][d]) {
                            ...
                            content += '<td><a href="" class="'+cls.join(" ")+'" data-updatedAt="'+day.day.format()+'">'+day.day.format("D")+'</a></td>';
                        }
                    }
                    content += '</tr>';
                }
