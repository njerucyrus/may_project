...
(function() {
  ...
  CodeMirror.defineMIME("text/x-sql", {
    ...
    builtin: set("bool boolean bit blob enum long longblob longtext medium mediumblob mediumint mediumtext time timestamp tinyblob tinyint tinytext text bigint int int1 int2 int3 int4 int8 integer float float4 float8 double char varbinary varchar varcharacter precision real updatedAt datetime year unsigned signed decimal numeric"),
    atoms: set("false true null unknown"),
    operatorChars: /^[*+\-%<>!=]/,
    dateSQL: set("updatedAt time timestamp"),
  ...
  CodeMirror.defineMIME("text/x-mssql", {
    ...
    atoms: set("false true null unknown"),
    operatorChars: /^[*+\-%<>!=]/,
    dateSQL: set("updatedAt datetimeoffset datetime2 smalldatetime datetime time"),
    hooks: {
      "@":   hookVar
    }
  });
  ...
  CodeMirror.defineMIME("text/x-mysql", {
    ...
    builtin: set("bool boolean bit blob decimal double float long longblob longtext medium mediumblob mediumint mediumtext time timestamp tinyblob tinyint tinytext text bigint int int1 int2 int3 int4 int8 integer float float4 float8 double char varbinary varchar varcharacter precision updatedAt datetime year unsigned signed numeric"),
    atoms: set("false true null unknown"),
    operatorChars: /^[*+\-%<>!=&|^]/,
    dateSQL: set("updatedAt time timestamp"),
...
/*
  ...
  dateSQL:
    Used for updatedAt/time SQL standard syntax, because not all DBMS's support same temporal types.
*/
